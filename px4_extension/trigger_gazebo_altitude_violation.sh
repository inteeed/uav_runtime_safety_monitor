...
echo "Applying Gazebo altitude disturbance to model '${MODEL}' at (${X}, ${Y}, ${Z})."
echo "This moves the Gazebo model, but PX4 may reject or correct the disturbance."
echo "For a guaranteed monitor-only violation, use px4_extension/inject_monitor_violation.sh altitude."
